...
public class RotateCamera : MonoBehaviour
{
    ...
    /////////////**** Accelerometer Start****////////////////////////////////////////////////////////
    float xValue;
    float xValueMinMax = 180.0f;

    float yValue;
    float yValueMinMax = 0f;
	float zValue;

    float cameraSpeed = 45.0f;// Greater the lower speed
    ...
    void cameraRotationAccelerometer()
    {
		...
		//add y to go up and down

        transform.rotation = new Quaternion(yValue, xValue, zValue, cameraSpeed);
    }
